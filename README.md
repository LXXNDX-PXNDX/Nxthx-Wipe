...
**Author:** LXXNDX-PXNDX
**Version:** 1.0  
**License:** For educational purposes / own networks only
...
### 2. Download files
Place these files in one folder or download the latest Release here:
...
Open Terminal, go to the folder and type:
